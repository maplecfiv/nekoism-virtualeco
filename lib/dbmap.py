...
DATABASE_PATH = {
	...
	"partner_motion_together": "./data/partner_motion_together.csv",
	"shop": "./data/shop.csv",
	"skill": "./data/skill.csv",
}


def get_row_map_raw(name):
	if name in DATABASE_ROW_MAP_RAW:
		return DATABASE_ROW_MAP_RAW[name]
	elif name in DATABASE_NAME_MAP:
		return get_row_map_raw(DATABASE_NAME_MAP[name])
	return {}

def get_row_map_ext(name):
	if name in DATABASE_ROW_MAP_EXT:
		return DATABASE_ROW_MAP_EXT[name]
	if name in DATABASE_NAME_MAP:
		return get_row_map_ext(DATABASE_NAME_MAP[name])
	return {}
...
DATABASE_ROW_MAP_RAW = {
	...
	"partner_motion_together":{
		#u"#パートナーのアイテムID": (dbint, "pet_id"),
		#u"連動番号": (dbint, "number"),
		#u"出現位置": (dbint, "position"),
		#u"向き": (dbint, "dir"),
		#u"モーションID": (dbint, "motion"),
		#u"向き": (dbint, "pc_dir"),
		#u"モーションID": (dbint, "pc_motion"),
		#u"備考": NULL,
	},
}
