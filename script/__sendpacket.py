...
def main(pc):
    ...
    #    common.log("skip", data_type.encode("hex"))
    #    continue
    #create raw packet
    ...
    packet_enc = common.encode(packet_raw, pc.user.map_client.rijndael_obj)
    #send
    common.log("send", data_type.encode("hex"), data_value.encode("hex"))
